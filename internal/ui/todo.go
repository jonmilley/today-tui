...
func newTodoPane(gh api.TodoBackend) todoPane {
	ti := textinput.New()
...
func fetchIssues(gh api.TodoBackend) tea.Cmd {
	return func() tea.Msg {
...
func closeIssue(gh api.TodoBackend, number int) tea.Cmd {
	return func() tea.Msg {
...
func submitCreateIssue(gh api.TodoBackend, title string) tea.Cmd {
	return func() tea.Msg {
